use crate::{paths, raylib_plugins::ImagePlugin};
use raylib::prelude::{
...
impl Window {
    ...
    pub fn draw(&self, raylib: &mut RaylibDrawHandle) {
        ...
        raylib.draw_rectangle_gradient_v(0, 0, 1, height, BORDER_TOP, BORDER_BOTTOM);
        raylib.draw_rectangle_gradient_v(width - 1, 0, 1, height, BORDER_TOP, BORDER_BOTTOM);
        raylib.draw_line(0, height - 1, width, height - 1, BORDER_BOTTOM);
    }
}
